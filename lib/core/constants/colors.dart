...
class AppColors {
  // static const Color primary = Color(0xff009FBD);
  static const Color primary = Color(0xff001B79);
  ...
  static const Color light2 = Color(0xffF7F7F7);
  static const Color blueLight = Color(0xffC7D0EB);
  static const Color blueLight2 = Color(0xffB6FFFA);
